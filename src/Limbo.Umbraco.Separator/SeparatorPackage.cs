...
public static class SeparatorPackage {
    ...
    /// </summary>
    public const string WebsiteUrl = "https://packages.limbo.works/limbo.umbraco.separator/v17/";

    /// <summary>
    /// Gets the URL of the documentation for this package.
    /// </summary>
    public const string DocumentationUrl = "https://packages.limbo.works/limbo.umbraco.separator/v17/docs/";
